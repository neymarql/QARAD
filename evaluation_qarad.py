...
from train_qarad import update_config
from utils.categories import Categories
from tqdm import tqdm


warnings.filterwarnings('ignore')
parser = argparse.ArgumentParser(description="evaluation QARAD")
...
def validate(config,val_loader, model,class_name):
    ...
    with torch.no_grad():
        for i, input in enumerate(tqdm(val_loader, total=len(val_loader), desc="Validating")):
